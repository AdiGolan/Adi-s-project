...
namespace WOLProject {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class DBDataTable : global::System.Data.TypedTableBase<DBRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DBRow AddDBRow(string IP, string MAC) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DBRow FindByIP(string IP) {
        ...
        public partial class DBRow : global::System.Data.DataRow {
            ...
            public string IP {
                get {
                    return ((string)(this[this.tableDB.IPColumn]));
                }
                set {
                    this[this.tableDB.IPColumn] = value;
                }
            }
            ...
            public string MAC {
                get {
                    try {
                        return ((string)(this[this.tableDB.MACColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'MAC\' in table \'DB\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableDB.MACColumn] = value;
                }
            }
            ...
            public bool IsMACNull() {
                return this.IsNull(this.tableDB.MACColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetMACNull() {
                this[this.tableDB.MACColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WOLProject.DatabaseDataSetTableAdapters {
    ...
    public partial class DBTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `DB` WHERE ((`IP` = ?) AND ((? = 1 AND `MAC` IS NULL) OR (`MAC` = ?))" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `DB` (`IP`, `MAC`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `DB` SET `IP` = ?, `MAC` = ? WHERE ((`IP` = ?) AND ((? = 1 AND `MAC` IS NU" +
                "LL) OR (`MAC` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\\Users\\User\\Documents\\Database.mdb" +
                "";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IP, MAC FROM DB";
        ...
        public virtual int Delete(string Original_IP, string Original_MAC) {
            if ((Original_IP == null)) {
        ...
        public virtual int Update(string IP, string MAC, string Original_IP, string Original_MAC) {
            if ((IP == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MAC, string Original_IP, string Original_MAC) {
            return this.Update(Original_IP, MAC, Original_IP, Original_MAC);
        }
    }
